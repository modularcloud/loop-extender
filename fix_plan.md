...
**Status: NOT spec-conformant. T-WFDIR-01..14 + T-TMP foundational subset + T-TMP-12 (26 sub-cases × 2 surfaces) + T-TMP-12-cli (10 sub-cases) + T-TMP-12-cli-usage (6 sub-cases) + T-TMP-12a/12b/12c (3 sub-cases) implemented; remaining P1 gaps in ADR-0004 coverage remain.**
...
- **Tmpdir-creation failure paths** — T-TMP-12d/12d2/12e/12e2/12e3 (LOOPX_TEST_TMPDIR_FAULT seam coverage), T-TMP-12f..12f5/12g/12h (version-check-vs-tmpdir-creation ordering).

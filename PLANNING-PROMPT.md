...
study ADR 0002 in the @adr/ directory so that you you can understand the modification recent modifications made to the SPEC and TEST-SPEC as per the process in ADR 0001.

...
- **T-MOD-03c**: Workflow-level `package.json` `type` field affects Node.js module resolution. Create `.loopx/ralph/package.json` with `{ "type": "module" }` and `.loopx/ralph/index.js` that uses `import { output } from "loopx"` (ESM syntax). Run `loopx run -n 1 ralph` under Node.js. Assert: execution succeeds and the script's output is observed. Remove the `package.json` (or set `"type": "commonjs"`) and re-run — if the runtime's `.js` handling depends on the `type` field, this exercises the boundary. This tests the Spec 2.1 statement that the `type` field remains relevant for Node.js module resolution within the workflow. `[Node]` *(Spec 2.1, 3.3)*
...
| 3.2 | Local Version Pinning & Delegation | T-DEL-01–26, T-VER-01–27, T-VER-04a, T-VER-07a–07f, T-VER-10a, T-VER-12a, T-VER-18a, T-VER-19a–19c, T-VER-24a, T-VER-25a, T-CLI-119, T-CLI-119c, T-CLI-119e–119f, T-MOD-03b, T-API-08b, T-API-08g, T-API-08o, T-API-08q, T-INST-72a, T-INST-73a |
...
| 9.1 | run() | T-API-01–09c, T-API-08a–08e, T-API-08g–08m, T-API-08o–08r, T-API-10–10c, T-API-20h–20i, T-API-20j–20k, T-API-30–37, T-API-35a–35e, T-API-36a, T-PARSE-20a, T-TYPE-04, T-TYPE-06–07 |
| 9.2 | runPromise() | T-API-08f, T-API-08n, T-API-08p2, T-API-11–14h, T-API-14a–14a3, T-API-25–25b, T-API-38–48, T-API-47a–47b, T-API-48a, T-API-44a–44b, T-PARSE-20a, T-TYPE-05–07 |
